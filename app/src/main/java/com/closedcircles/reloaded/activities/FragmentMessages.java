...
public class FragmentMessages extends android.support.v4.app.Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		Typeface authTypeface = FontLoader.getTypeface(getActivity(), FontLoader.ROBOTO_ITALIC);
		Typeface msgTypeface = FontLoader.getTypeface(getActivity(), FontLoader.MESSAGES_FONT);
